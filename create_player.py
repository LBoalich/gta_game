...
def create_player():
    ...
    player_1_hacking_ability = input('Have you hacked a laptop before?  Would you say you are a beginner, average or excellent hackerman? ').lower()
    while player_1_hacking_ability != 'beginner' and player_1_hacking_ability != 'average' and player_1_hacking_ability != 'excellent':
        player_1_hacking_ability = input('Yuno thinks you may have accidentally typed something wrong.  Please type either beginner, average, or excellent for your hacking ability: ').lower()
